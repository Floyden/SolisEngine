...
pub fn main() !void {
    ...
    var asset_server = world.initGlobal(assets.Server, assets.Server.init(std.heap.page_allocator));
    ...
    var renderer = world.initGlobal(Renderer, try Renderer.init(window));
