...
pub const Description = struct {
    ...
    address_mode_u: u32 = c.SDL_GPU_SAMPLERADDRESSMODE_REPEAT,
    address_mode_v: u32 = c.SDL_GPU_SAMPLERADDRESSMODE_REPEAT,
    address_mode_w: u32 = c.SDL_GPU_SAMPLERADDRESSMODE_REPEAT,
